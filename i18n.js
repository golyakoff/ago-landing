...
var AGO_I18N = {
  en: {
    ...
    'pricingpage.ladder.body':'Not a second price list — these are the two prices above, added up. The base price covers three seats, which is why the total does not move below three operators.',
    'pricingpage.ladder.col1':'Operator seats','pricingpage.ladder.col2':'Per month','pricingpage.ladder.col3':'What it is made of',
    'pricingpage.ladder.of2':'Base price','pricingpage.ladder.of3':'Base price',
    'pricingpage.ladder.of4':'Base + 1 seat','pricingpage.ladder.of5':'Base + 2 seats',
  ...
  ru: {
    ...
    'pricingpage.ladder.body':'Это не второй прайс-лист — это те же две цены выше, сложенные. Базовая цена покрывает три места, поэтому до трёх операторов сумма не меняется.',
    'pricingpage.ladder.col1':'Операторских мест','pricingpage.ladder.col2':'В месяц','pricingpage.ladder.col3':'Из чего складывается',
    'pricingpage.ladder.of2':'Базовая цена','pricingpage.ladder.of3':'Базовая цена',
    'pricingpage.ladder.of4':'База + 1 место','pricingpage.ladder.of5':'База + 2 места',
