...
var AGO_I18N = {
  en: {
    ...
    'pricing.paid.f5':'A connected channel beyond the widget — Telegram, WhatsApp, SMS and others, one flat price — real, but not publicly priced yet. Ask us.',
    ...
    'pricingpage.units.channel.note':'One flat price for any channel — Telegram, WhatsApp, SMS and others, arriving one at a time in the same operator console. The published price for it is not out yet, so this page will not print one. Ask us and we will tell you.',
  ...
  ru: {
    ...
    'pricing.paid.f5':'Подключённый канал сверх виджета — Telegram, WhatsApp, SMS и другие, одна цена на все — он есть, но публичной цены пока нет. Напишите нам.',
    ...
    'pricingpage.units.channel.note':'Одна цена на любой канал — Telegram, WhatsApp, SMS и другие, они появляются в консоли оператора по одному. Опубликованной цены у неё пока нет, и выдумывать её эта страница не станет. Напишите нам, и мы назовём.',
