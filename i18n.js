...
var AGO_I18N = {
  en: {
    ...
    'pricing.soon.channels':'More channels — Telegram, WhatsApp, SMS',
    ...
    'pricingpage.units.body':'Two published prices, and one thing that is real in the product but has no published price yet.',
    ...
    'pricingpage.soon.channels':'More incoming channels',
    'pricingpage.soon.channels.note':'Telegram, WhatsApp, SMS and others, arriving in the same operator console as the website chat.',
  ...
  ru: {
    ...
    'pricing.soon.channels':'Другие каналы — Telegram, WhatsApp, SMS',
    ...
    'pricingpage.units.body':'Две опубликованные цены — и одна вещь, которая в продукте есть, а опубликованной цены у неё пока нет.',
    ...
    'pricingpage.soon.channels':'Другие входящие каналы',
    'pricingpage.soon.channels.note':'Telegram, WhatsApp, SMS и другие — приходят в ту же консоль оператора, что и чат с сайта.',
    'pricingpage.soon.calendar':'AGO Calendar',
