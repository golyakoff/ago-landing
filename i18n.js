...
var AGO_I18N = {
  en: {
    ...
    'pricing.paid.f4':'Each Administrator beyond the two included —',
    'pricing.paid.f5':'Each connected channel beyond the widget — Telegram, MAX, VK, WhatsApp, Avito and email are already live, one flat price for any —',
    ...
    'pricingpage.units.body':'Every figure below is a price the product actually published - never a rounded example, never a plan for what it will charge someday.',
    ...
    'pricingpage.units.admin':'Each administrator past the second','pricingpage.units.admin.note':'Charged for every Administrator beyond the two a paid plan already includes.',
    'pricingpage.units.channel':'Each connected channel beyond the website widget',
    'pricingpage.units.channel.note':'One flat price for any channel — Telegram, MAX, VK, WhatsApp, Avito and email are already live, in the same operator console as the website chat.',
  ...
  ru: {
    ...
    'pricing.paid.f4':'Каждый администратор сверх двух включённых —',
    'pricing.paid.f5':'Каждый подключённый канал сверх виджета — Telegram, MAX, VK, WhatsApp, Avito и почта уже подключаются, одна цена на любой —',
    ...
    'pricingpage.units.body':'Каждая цифра ниже — цена, которую продукт действительно опубликовал, а не округлённый пример и не план когда-нибудь столько брать.',
    ...
    'pricingpage.units.admin':'Каждый администратор сверх второго','pricingpage.units.admin.note':'Считается сверх двух администраторов, которых уже включает платный тариф.',
    'pricingpage.units.channel':'Каждый подключённый канал сверх виджета на сайте',
    'pricingpage.units.channel.note':'Одна цена на любой канал — Telegram, MAX, VK, WhatsApp, Avito и почта уже подключаются, в той же консоли оператора, что и чат на сайте.',
